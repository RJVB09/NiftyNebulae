    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            */
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                backGroundColor.a = min(backGroundColor.a,sceneDepth);
                float thickness = backGroundColor.a-length(i.worldPos - _WorldSpaceCameraPos);
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 backGroundColor = tex2D(_GrabTexture, screenSpaceUV);
                float thickness = length(i.worldPos - _WorldSpaceCameraPos);
                thickness = min(depthVal,thickness);
